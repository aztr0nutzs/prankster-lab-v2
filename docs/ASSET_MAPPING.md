...
| `prankstar_headers/prankstar_sn2.png`  | `app/src/main/res/drawable/prankstar_sn2.png`                  | Legacy Prankstar header variant retained for screens that opt into it. |
...
- Sound Forge / Randomizer / Library / Settings / Voice Lab / Packs UIs,
